...
Проект построен по принципам **Clean Architecture** с использованием **Riverpod** для управления состоянием:
lib/
├── core/                    # Базовые настройки и общие компоненты
│   ├── constants/          # Константы приложения
│   ├── themes/             # Темы и цветовая схема
│   ├── utils/              # Утилиты и хелперы
│   ├── network/            # Сетевой слой (Firebase)
│   ├── routing/            # Маршрутизация (GoRouter)
│   └── providers/          # Глобальные провайдеры
├── features/               # Функциональные модули
│   ├── auth/               # Авторизация и регистрация
│   ├── onboarding/         # Экраны первого запуска
│   ├── home/               # Главный экран
│   ├── care_tracker/       # Трекер ухода
│   ├── health_calendar/    # Календарь здоровья
